...
import com.example.pexel.view.DetailScreenActivity;
...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.ViewHolder> {
    ...
    public PhotoAdapter(Context context, ArrayList<Photos> articleArrayList, OnItemClick itemClick) {
    ...
    public void onBindViewHolder(@NonNull PhotoAdapter.ViewHolder viewHolder, int i) {
        ...
        viewHolder.imgViewCover.setOnClickListener(v -> {
            ...
            intent.putExtra(AppConstant.DATA, article.getSrc().getOriginal());
            intent.putExtra(AppConstant.TOOLBAR_TITLE, article.getPhotographer());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (itemClick != null) {
                itemClick.onItemClicked(photoList, getAdapterPosition());
            }
        }
    }
}
